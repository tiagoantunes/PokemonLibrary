...
extension PokemonType {
    ...
    var color: [Color] {
        ...
        case .flying:       
            return [Color.iceFlyingType1, Color.flyingType2]
        case .poison:
            return [Color.poisonType]
        case .ground:
            return [Color.groundType1,Color.groundType2]
        case .rock:
        ...
        case .ice:
            return [Color.iceFlyingType1]
        case .dragon:
            return [Color.dragonType1, Color.dragonType2]
        case .dark:
